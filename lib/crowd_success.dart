...
class CrowdSuccess extends StatefulWidget {
  static const String id = 'crowd_success';
  @override
  State<CrowdSuccess> createState() => _CrowdSuccessState();
}

class _CrowdSuccessState extends State<CrowdSuccess> {
  @override
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 12),
              Text(
                'You have successfully created your group saving account, best wishes. 🎉',
                style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.w400,
