...
class AddCardPassword extends StatefulWidget {
  static const String id = 'add_card_password';
  @override
  State<AddCardPassword> createState() => _AddCardPasswordState();
}

class _AddCardPasswordState extends State<AddCardPassword> {
  @override
          ...
          child: Column(
            ...
            children: [
              ...
              Button(
                  caption: 'Next',
                  tapMe: () {
                    Navigator.pushNamed(context, AddCardSuccess.id);
                  }),
              SizedBox(height: 71)
            ],
          ),
